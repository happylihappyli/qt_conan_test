...
struct qt_meta_stringdata_CustomWebPage_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CustomWebPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CustomWebPage_t qt_meta_stringdata_CustomWebPage = {
    {
QT_MOC_LITERAL(0, 0, 13) // "CustomWebPage"
...
static const uint qt_meta_data_CustomWebPage[] = {
...
QT_INIT_METAOBJECT const QMetaObject CustomWebPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWebEnginePage::staticMetaObject>(),
    qt_meta_stringdata_CustomWebPage.data,
    qt_meta_data_CustomWebPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CustomWebPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CustomWebPage.stringdata0))
