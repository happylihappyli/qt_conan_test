...
for %%v in (QT_PLUGIN_PATH PATH) do (
    set foundenvvar=
...
set "QT_PLUGIN_PATH=C:\Users\happyli\.conan2\p\b\qtb73b254637aeb\p\plugins"
set "PATH=C:\Users\happyli\.conan2\p\b\qtb73b254637aeb\p\bin;%PATH%"